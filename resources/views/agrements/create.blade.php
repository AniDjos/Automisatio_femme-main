...
@section('title', 'Créer un Agrément')

@section('content')
<div class="elegant-form-container">
    <div class="form-header">
        <h1 class="form-title">
            <i class="bx bx-file-blank"></i> Nouvel Agrément
        </h1>
        <p class="form-subtitle">Remplissez les informations pour créer un nouvel agrément</p>
    </div>

    <form action="{{ route('agrement.store') }}" method="POST" enctype="multipart/form-data" class="elegant-form">
        @csrf
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <input type="text" id="structure" name="structure" placeholder="Nom de la structure" value="{{ old('structure') }}" required>
            ...
            <div class="form-group">
                ...
                <div class="input-with-icon">
                    <input type="text" id="reference" name="reference" placeholder="Référence de l'agrément" value="{{ old('reference') }}" required>
            ...
            <div class="form-group">
                ...
                <div class="select-with-icon">
                    <select id="groupement_id" name="groupement_id" required>
                        <option value="" disabled selected>Sélectionnez un groupement</option>
            ...
            <div class="form-group full-width">
                <label for="document">
                    <i class="bx bx-cloud-upload"></i> Document
                </label>
                <div class="file-upload-container">
                    <label for="document" class="file-upload-label">
                        ...
                        <input type="file" id="document" name="document" required hidden>
                    </label>
                </div>
                @error('document')
                    <span class="error-message"><i class="bx bx-error"></i> {{ $message }}</span>
        ...
        <div class="form-actions">
            <button type="submit" class="btn btn-primary">
                <i class="bx bx-save"></i> Enregistrer l'Agrément
            </button>
