                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="nom" name="nom" placeholder="Entrez le nom du groupement">
                        </div>
                    </div>
            ...
            <div class="form-step">
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <select id="activite_principale" name="activite_principale">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" id="effectif" name="effectif" placeholder="Entrez l'effectif" min="1">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" id="revenu" name="revenu" placeholder="Entrez votre revenu mensuel" min="0"
                                step="0.01">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" id="depense" name="depense" placeholder="Entrez votre dépense mensuelle"
                                min="0" step="0.01">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="number" id="benefice" name="benefice" placeholder="Entrez votre bénéfice mensuel"
                                min="0" step="0.01">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        <i class="bx bx-credit-card input-icon"></i>
                        <input type="text" id="source_financement" name="source_financement"
                            placeholder="Entrez la source de financement">
                    </div>
                </div>
                ...
                <div id="appui-details" class="conditional-section" style="display: none;">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper textarea-wrapper">
                            ...
                            <textarea id="description_appui" name="description_appui"
                                placeholder="Entrez une description de l'appui" rows="4"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group toggle-group">
                        <div class="toggle-label">
                            <label for="appui_masm">Avez-vous reçu un appui de MASM ?</label>
                            <div class="toggle-switch">
                                <input type="checkbox" id="appui_masm" name="appui_masm" value="1">
                                <span class="toggle-slider"></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-step">
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="equipement" name="equipement" placeholder="Entrez l'équipement">
                        </div>
                    </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper textarea-wrapper">
                        ...
                        <textarea id="description_difficulte" name="description_difficulte"
                            placeholder="Décrivez les difficultés rencontrées" rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper textarea-wrapper">
                        ...
                        <textarea id="description_besoin" name="description_besoin" placeholder="Décrivez vos besoins"
                            rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="form-grid">
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="text" id="reference" name="reference" placeholder="Entrez la référence">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-wrapper">
                            ...
                            <input type="date" id="annee_delivrance" name="annee_delivrance">
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group file-upload-group">
                    ...
                    <div class="file-upload-wrapper">
                        ...
                        <input type="file" id="agrement" name="agrement" multiple accept=".pdf,.doc,.docx,.jpg,.png">
                    </div>
